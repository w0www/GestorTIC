...
class Setup < ActiveRecord::Migration
  ...
  def self.up
    ...
    user = User.new :firstname => "lanbideadmin",
                    :lastname => "Admin",
                    :mail => "alberto.jimenezlozano@gmail.com", :language => "es",
                    :mail_notification => true,
                    :status => 1
    user.login = 'lanbideadmin'
    user.hashed_password = "2849447995d2a616c7fa19b3eed93bf58e1098f0"
    user.admin = true
    user.save
